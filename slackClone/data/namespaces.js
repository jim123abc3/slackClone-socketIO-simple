...
const mozNs = new Namespace(0, 'Mozilla', 'https://www.mozilla.org/media/img/logos/firefox/logo-quantum.9c5e96634f92.png', '/mozilla')
const linuxNs = new Namespace(0, 'Wikipedia', 'https://upload.wikimedia.org/wikipedia/commons/a/af/Tux.png', '/linux')
...
mozNs.addRoom(new Room(2, 'Rust', 1,))
